...
<script setup>
import { uploadFileAPI, knowledgeArticleAPI, knowledgeArticleUpdateAPI, deleteFileAPI, } from "@/apis/backend/knowledge"
...
const handleDelete = async () => {
 if (formData.coverImage) {
    await deleteFileAPI(formData.coverImage)
