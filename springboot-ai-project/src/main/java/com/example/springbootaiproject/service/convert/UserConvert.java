package com.example.springbootaiproject.service.convert;
...
public class UserConvert {
    ...
    public static User entityToRegisterResponse(UserRegisterCommandDTO commandDTO, String encodedPassword) {
        return User.builder()
                ...
                .status(UserStatus.NORMAL.getCode())//注册时默认状态为正常
