    ...
    <div class="navbar-container">
      <div class="navbar-content">
        ...
        <div class="nav-section">
          ...
          <template v-else>
            <router-link to="/auth/login" class="nav-item"  @click="handleThemeChange(false)">登录</router-link>
            <router-link to="/auth/register" class="nav-item nav-highlight" @click="handleThemeChange(false)">注册</router-link>
          </template>
        </div>
      </div>
    </div>
    <div class="main-content">
      <!-- 路由出口，根据路由动态加载组件，并添加过渡效果 -->
